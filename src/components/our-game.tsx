...
const OurGame = memo(function OurGame() {
  return (
    <div className="bg-[#2E2D2E] py-12 mt-6 rounded-3xl ">
      <div className="px-12">
        <h1 className="text-3xl font-bold text-white pt-12 ">Our Games</h1>
      ...
      <div className="md:flex justify-between px-5 pb-12 h-[140vh] md:h-screen relative">
        <div className=" first w-full md:w-[45%] xl:w-1/2 h-[60vh] md:h-[95vh]  left-4 xl:left-12  md:px-12 pb-3 relative">
        ...
        <div className="second w-full md:w-[45%] xl:w-1/2 h-[60vh] mt-6 md:mt-0 md:h-[95vh] absolute right-4 xl:right-12">
